...
## [攻读博士学位目的](个人技能)
本人拥有扎实的开发能力与成熟的工程经验，能够为博士阶段的研究工作提供有力支撑。在过往项目中，多次主导并完成核心功能开发，具备系统架构设计与性能优化的实践能力，同时在解决瓶颈问题上展现出敏锐的洞察力与出色的攻关能力。

拟攻读博士方向为**机载软件大模型关键技术及平台**，在软件研发、性能调优与架构设计上的积累，有助于快速开展并推进课题进展。希望通过博士阶段的学习与研究，拓宽技术视野，更深入地掌握计算机与软件领域的前沿技术，培养系统的科研思维与创新能力，推进我国关键软件技术的进一步发展。
## 个人技能
- 熟悉基于Linux/Windows的Java/Python/C/C++/JS开发的相关技术栈，具备基于Pytorch的深度学习研究经验
...
- 了解Vue3、前端、lua、Electron、Unity开发、UE开发
